...
public class OpossumModel<T extends OpossumEntity> extends EntityModel<T> {
    ...
    public OpossumModel() {
        ...
        head.setTextureOffset(16, 24).addBox(-5.5F, -6.0F, -8.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
        head.setTextureOffset(0, 0).addBox(-4.5F, -4.0F, -10.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        head.setTextureOffset(16, 16).addBox(-2.5F, -7.0F, -6.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(26, 16).addBox(-6.5F, -7.0F, -6.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        TopRightLeg = new ModelRenderer(this);
        TopRightLeg.setRotationPoint(0.0F, 24.0F, 0.0F);
        TopRightLeg.setTextureOffset(8, 21).addBox(-6.0F, -3.0F, -3.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        TopLeftLeg = new ModelRenderer(this);
        TopLeftLeg.setRotationPoint(0.0F, 24.0F, 0.0F);
        TopLeftLeg.setTextureOffset(8, 16).addBox(-3.0F, -3.0F, -3.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        BotomRightLeg = new ModelRenderer(this);
        BotomRightLeg.setRotationPoint(0.0F, 24.0F, 0.0F);
        BotomRightLeg.setTextureOffset(0, 21).addBox(-3.0F, -3.0F, 2.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        BotomLeftLeg = new ModelRenderer(this);
        BotomLeftLeg.setRotationPoint(0.0F, 24.0F, 0.0F);
        BotomLeftLeg.setTextureOffset(0, 16).addBox(-6.0F, -3.0F, 2.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        cube_r1.setRotationPoint(-3.0F, -5.0F, 3.0F);
